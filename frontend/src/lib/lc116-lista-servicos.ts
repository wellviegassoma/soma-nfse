// Lista de serviços anexa à LC 116/2003 (com as alterações da LC
// 157/2016) — texto conferido contra o Planalto em 27/08/2026 (mesma
// fonte já citada em lc116-sugestao-atividade.ts). Chave: item.subitem
// sem ponto, 4 dígitos (ex.: "0401" pra 4.01) — os 2 primeiros dígitos
// do `national_tax_code` (6 dígitos) sempre correspondem a isso; os 2
// últimos são uma subclassificação da NFS-e nacional sem
// correspondência na própria LC 116, por isso não entram aqui.
//
// Só pra mostrar a descrição enquanto o código é digitado no cadastro
// de serviço (facilita preencher certo) — nunca decide nada sozinha.
export const LC116_DESCRICOES: Record<string, string> = {
  ...
  "0107": "Suporte técnico em informática, inclusive instalação, configuração e manutenção.",
  ...
  "0303": "Exploração de salões de festas, centro de convenções, escritórios virtuais, stands, quadras esportivas e congêneres.",
  "0304": "Locação, sublocação, arrendamento, direito de passagem ou permissão de uso de ferrovia, rodovia, postes, cabos, dutos e condutos de qualquer natureza.",
  ...
  "0716": "Florestamento, reflorestamento, semeadura, adubação, reparação de solo, plantio, silagem, colheita, corte e descascamento de árvores, silvicultura, exploração florestal e congêneres.",
  ...
  "0901": "Hospedagem de qualquer natureza em hotéis, apart-service condominiais, flat, apart-hotéis, hotéis residência, residence-service, suite service, hotelaria marítima, motéis, pensões e congêneres; ocupação por temporada com fornecimento de serviço.",
  ...
  "1401": "Lubrificação, limpeza, lustração, revisão, carga e recarga, conserto, restauração, blindagem, manutenção e conservação de máquinas, veículos, aparelhos, equipamentos, motores, elevadores ou de qualquer objeto.",
  "1402": "Assistência técnica.",
  "1403": "Recondicionamento de motores.",
  ...
  "1510": "Serviços relacionados a cobranças, recebimentos ou pagamentos em geral, de títulos quaisquer, de contas ou carnês, de câmbio, de tributos e por conta de terceiros, inclusive os efetuados por meio eletrônico, automático ou por máquinas de atendimento.",
  ...
  "2501": "Funerais, inclusive fornecimento de caixão, urna ou esquifes; aluguel de capela; transporte do corpo cadavérico; fornecimento de flores, coroas e outros paramentos; desembaraço de certidão de óbito; fornecimento de véu, filme ou outros materiais aplicados no embalsamamento, embelezamento, conservação ou restauração de cadáveres.",
...
export function descricaoLc116(codigoNacional6Digitos: string | null | undefined): string | undefined {
  if (!codigoNacional6Digitos) return undefined;
  const chave = codigoNacional6Digitos.trim().slice(0, 4);
  return LC116_DESCRICOES[chave];
}
