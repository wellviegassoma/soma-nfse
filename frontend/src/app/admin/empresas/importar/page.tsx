    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-foreground/60">
          Suba uma planilha (.xlsx ou .csv) com uma coluna de nome e uma de CNPJ — buscamos razão
          social, nome fantasia, CNAE e demais dados automaticamente na Receita Federal para cada
          linha.
        </p>
      </div>
