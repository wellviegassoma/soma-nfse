...
import { importarFechamentoXml } from "@/lib/actions/fechamento";
import { Button } from "@/components/ui/Button";
import { Input } from "@/components/ui/Input";
import { Field } from "@/components/ui/Field";
import { Alert } from "@/components/ui/Alert";

export function ImportFechamentoForm({ companyId }: { companyId: string }) {
  const [state, formAction, pending] = useActionState(importarFechamentoXml, undefined);
    ...
    <div className="flex flex-col gap-5">
      <form action={formAction} className="flex flex-col gap-4">
        ...
        <Field
          ...
          htmlFor="files"
          hint="Pode selecionar vários de uma vez — cada um deve ser o XML de uma nota emitida ou recebida"
        >
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href={`/admin/empresas/${companyId}/fechamento`}
