...
export const metadata = { title: "Parâmetros de precificação — Painel SOMA" };

export default async function AdminPrecificacaoParametrosPage(
  props: PageProps<"/admin/empresas/[companyId]/precificacao/parametros">,
) {
