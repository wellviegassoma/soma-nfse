...
# --- Integra-Parcelamentos (versão 1.0 confirmada no PARCSN; assumida
# igual nas modalidades irmãs, já que a documentação é claramente
# templated/idêntica entre elas — confirme a versão antes do primeiro uso
# de cada modalidade específica) ---
_registrar(
    ...
    _s("PARCSN-ESP", "GERARDAS171", "Emitir", None, procuracao_codigo="00125"),
    _s("PARCSN-ESP", "PARCELASPARAGERAR172", "Consultar", None, procuracao_codigo="00125"),
    _s("PARCSN-ESP", "PEDIDOSPARC173", "Consultar", None, procuracao_codigo="00125"),
    _s("PARCSN-ESP", "OBTERPARC174", "Consultar", None, procuracao_codigo="00125"),
    _s("PARCSN-ESP", "DETPAGTOPARC175", "Consultar", None, procuracao_codigo="00125"),
    _s("PERTSN", "GERARDAS181", "Emitir", None, procuracao_codigo="00149/10011"),
    _s("PERTSN", "PARCELASPARAGERAR182", "Consultar", None, procuracao_codigo="00149/10011"),
    _s("PERTSN", "PEDIDOSPARC183", "Consultar", None, procuracao_codigo="00149/10011"),
    _s("PERTSN", "OBTERPARC184", "Consultar", None, procuracao_codigo="00149/10011"),
    _s("PERTSN", "DETPAGTOPARC185", "Consultar", None, procuracao_codigo="00149/10011"),
    _s("RELPSN", "GERARDAS191", "Emitir", None, procuracao_codigo="00210/10036"),
    _s("RELPSN", "PARCELASPARAGERAR192", "Consultar", None, procuracao_codigo="00210/10036"),
    _s("RELPSN", "PEDIDOSPARC193", "Consultar", None, procuracao_codigo="00210/10036"),
    _s("RELPSN", "OBTERPARC194", "Consultar", None, procuracao_codigo="00210/10036"),
    _s("RELPSN", "DETPAGTOPARC195", "Consultar", None, procuracao_codigo="00210/10036"),
    _s("PARCMEI", "GERARDAS201", "Emitir", None, procuracao_codigo="00134"),
    _s("PARCMEI", "PARCELASPARAGERAR202", "Consultar", None, procuracao_codigo="00134"),
    _s("PARCMEI", "PEDIDOSPARC203", "Consultar", None, procuracao_codigo="00134"),
    _s("PARCMEI", "OBTERPARC204", "Consultar", None, procuracao_codigo="00134"),
    _s("PARCMEI", "DETPAGTOPARC205", "Consultar", None, procuracao_codigo="00134"),
    _s("PARCMEI-ESP", "GERARDAS211", "Emitir", None, procuracao_codigo="00133"),
    _s("PARCMEI-ESP", "PARCELASPARAGERAR212", "Consultar", None, procuracao_codigo="00133"),
    _s("PARCMEI-ESP", "PEDIDOSPARC213", "Consultar", None, procuracao_codigo="00133"),
    _s("PARCMEI-ESP", "OBTERPARC214", "Consultar", None, procuracao_codigo="00133"),
    _s("PARCMEI-ESP", "DETPAGTOPARC215", "Consultar", None, procuracao_codigo="00133"),
    _s("PERTMEI", "GERARDAS221", "Emitir", None, procuracao_codigo="00152/10012"),
    _s("PERTMEI", "PARCELASPARAGERAR222", "Consultar", None, procuracao_codigo="00152/10012"),
    _s("PERTMEI", "PEDIDOSPARC223", "Consultar", None, procuracao_codigo="00152/10012"),
    _s("PERTMEI", "OBTERPARC224", "Consultar", None, procuracao_codigo="00152/10012"),
    _s("PERTMEI", "DETPAGTOPARC225", "Consultar", None, procuracao_codigo="00152/10012"),
    _s("RELPMEI", "GERARDAS231", "Emitir", None, procuracao_codigo="00209/10035"),
    _s("RELPMEI", "PARCELASPARAGERAR232", "Consultar", None, procuracao_codigo="00209/10035"),
    _s("RELPMEI", "PEDIDOSPARC233", "Consultar", None, procuracao_codigo="00209/10035"),
    _s("RELPMEI", "OBTERPARC234", "Consultar", None, procuracao_codigo="00209/10035"),
    _s("RELPMEI", "DETPAGTOPARC235", "Consultar", None, procuracao_codigo="00209/10035"),
)
